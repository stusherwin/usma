...
export interface OrderItem { productId: number
                             productCode: string
                             productName: string
...
export interface Order { totalExcVat: number
                         totalIncVat: number
                         items: OrderItem[]
                       }

export interface ProductCatalogueEntry { code: string
                                         name: string
                                         priceExcVat: number
                                         priceIncVat: number
                                         vatRate: VatRate
...
export interface Household { id: number
                             name: string
...
export interface CollectiveOrder extends Order { id: number
                                                 createdDate: Date
                                                 createdBy: number
...
export interface PastCollectiveOrder extends Order { id: number
                                                     createdDate: Date
                                                     createdBy: number
                                                     createdByName: string
                                                     isAbandoned: boolean
...
export interface HouseholdOrder extends Order { orderId: number
...
export interface PastHouseholdOrder extends Order { orderId: number
                                                    orderCreatedDate: Date
                                                    orderCreatedBy: number
                                                    orderCreatedByName: string
                                                    householdId: number
...
export interface HouseholdPayment { id: number 
                                    householdId: number
                                    date: Date
                                    amount: number
                                  }