...
export const OrderItem = ({ item
  ...
  return <React.Fragment>
    <tr>
      <td className={classNames('w-20 h-20 align-top pl-2 bg-green-lighest pt-4', {'bg-green-lightest': checkedOff})} rowSpan={3}>
        <img className="w-20 h-20 -ml-1" src={ServerApi.url(`query/product-image/${item.productCode}`)} />
      </td>
      <td className={classNames('pb-2 pl-2 font-bold align-baseline whitespace-no-wrap pt-4', {'bg-green-lightest': checkedOff})}>
        {checkedOff && '\u2713 '}{item.productCode}
      </td>
      <td className={classNames('pl-2 pb-2 align-baseline whitespace-no-wrap pt-4', {'bg-green-lightest': checkedOff})}>
        {!!editItemQuantity
      ...
      <td className={classNames('pl-2 pr-2 pb-2 text-right align-baseline whitespace-no-wrap pt-4', {'bg-green-lightest': checkedOff})}>
    ...
    <tr>
      <td className={classNames('pb-2 pl-2 align-top', {'bg-green-lightest': checkedOff})} colSpan={2}>
        {item.productName}
      </td>
      <td className={classNames('pl-2 pr-2 align-top text-right', {'bg-green-lightest': checkedOff})}>
        {!!removeItem &&
    ...
    <tr>
      <td className={classNames('pl-2 pb-4', {'bg-green-lightest': checkedOff})} colSpan={3}>
        <span className="pr-2">
          <ProductFlags p={item} />
        </span>
