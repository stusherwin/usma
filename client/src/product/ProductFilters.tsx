...
export const ProductFilters = ({searchString, flags, categories, brands, searchChanged, flagChanged, categoryChanged, brandChanged}: ProductFiltersProps) => (
  <div className="bg-product-light p-2 pt-0">
    ...
    <div className="relative mt-2 flex space-between">
        <select className="mr-1" style={{flexBasis: '50%', maxWidth: 'calc(50% - 0.25rem)'}} onChange={e => categoryChanged(e.target.value)}>
        ...
        <select className="ml-1" style={{flexBasis: '50%', maxWidth: 'calc(50% - 0.25rem)'}} onChange={e => brandChanged(e.target.value)}>
