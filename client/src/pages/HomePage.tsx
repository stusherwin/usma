  ...
  render() {
    return (
      <div className="h-screen">
        ...
        <RouterLink className="bg-household-light p-2 h-1/3 text-household-darker block no-underline hover:text-household-dark hover:no-underline" path="/households">
        ...
        <RouterLink className="bg-product-light p-2 h-1/3 text-white block no-underline hover:text-product-lightest hover:no-underline" path="/products">
          <div className="flex w-4/5 mt-2 pr-2">
        ...
        <RouterLink className="bg-order-dark p-2 h-1/3 text-black block no-underline hover:text-grey-darkest hover:no-underline" path="/orders">
