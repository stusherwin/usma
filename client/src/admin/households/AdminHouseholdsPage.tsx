...
export interface AdminHouseholdsPageProps {
...
export interface AdminHouseholdsPageState {
...
export class AdminHouseholdsPage extends React.Component<AdminHouseholdsPageProps, AdminHouseholdsPageState> {
  ...
  startEdit = (household: Household) => this.setState({
    editing: household.id
                      ...
                      <RouterLink className={classNames("p-2 py-4 min-h-24 block no-underline text-black hover:underline hover:text-black relative hover:bg-household-lightish", { "shadow-inner-top": i == 0 })} path={`/admin/households/${h.id}`}>
                        ...
                        <div className="ml-20 flex items-baseline justify-between">
                          ...
                          <div className="flex flex-col items-end">
                            ...
                            <button className={classNames({ "mt-2": this.props.groupSettings.enablePayments })} onClick={e => { e.stopPropagation(); this.delete(h) }} disabled={!!this.state.editing}><Icon type="delete" className="w-4 h-4 fill-current nudge-d-1" /></button>
                          </div>
                        </div>
                      </RouterLink>
                    ))}
