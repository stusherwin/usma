...
export interface AdminProductsPageState {
  uploading: boolean
...
export class AdminProductsPage extends React.Component<AdminProductsPageProps, AdminProductsPageState> {
  constructor(props: AdminProductsPageProps) {
    ...
    this.state = {
      filteredProducts: new FilteredProducts(props.products, props.categories, this.props.brands)
      , uploading: false
  ...
  render() {
    return (
      <div className="bg-product-light min-h-screen">
        ...
        <ProductList
          products={this.state.filteredProducts.products}
